...
ENV GALAXY_CONFIG_BRAND="Sperm Histone ChIP-Seq"

# Adding the tool definitions to the container
ADD sperm_chip_seq_tools.yml $GALAXY_ROOT/sperm_chip_seq_tools.yml

# Install tools
RUN install-tools $GALAXY_ROOT/sperm_chip_seq_tools.yml
